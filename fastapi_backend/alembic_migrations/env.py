...
def make_async_database_url(url: str) -> str:
    ...
    if url.startswith("postgresql://"):
        return _normalize_asyncpg_ssl(url.replace("postgresql://", "postgresql+asyncpg://", 1))
    if url.startswith("postgres://"):
        return _normalize_asyncpg_ssl(url.replace("postgres://", "postgresql+asyncpg://", 1))
    return _normalize_asyncpg_ssl(url)
...
async_db_connection_url = make_async_database_url(database_url)
